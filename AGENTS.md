...
- Update `memory/MEMORY.md` with distilled learnings
...
- When you learn a lesson → update `memory/AGENTS.md`, `memory/TOOLS.md`, or the relevant skill
...
Skills provide your tools. When you need one, check your Skills. Keep local notes (camera names, SSH details, voice preferences) in `TOOLS.md`.
